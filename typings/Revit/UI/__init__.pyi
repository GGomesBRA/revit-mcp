...
class UIApplication:
    ...
    def add_ExternalDataManagerChanged(self, handler: EventHandler) -> None: ...
    def remove_ExternalDataManagerChanged(self, handler: EventHandler) -> None: ...
...
class PostableCommand:
    ...
    Multiplanar = 50051
    OpenProject = 51800
    LoadCasesDisplay = 53531
    LoadCasesAndCombinations = 53532
